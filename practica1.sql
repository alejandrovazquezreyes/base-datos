...
BEGIN
   ...
   FOR I IN 1..200000 LOOP
    INSERT INTO DANCE VALUES(I,'ALEJANDRO',44);
 ...
 --SISTEMITA DE PELICULAS, LA DE SALA SERA TAREA
...
CREATE TABLE HORARIO (ID_HORARIO INTEGER,
                      ID_PELICULA INTEGER,
                      HORARIO VARCHAR2(8),
                      CONSTRAIN PK_ID_HORARIO PRIMARY KEY(ID_HORARIO),
                      CONSTRAIN PK1_ID_PELICULA FOREIGN KEY(ID_PELICULA) REFERENCES PELICULAS(ID_PELICULA)
                      );
